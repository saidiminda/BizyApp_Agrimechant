...
class FarmerManagementScreen extends GetWidget<FarmerManagementController> {
  const FarmerManagementScreen({Key? key}) : super(key: key);
  ...
  onTapAddFarmer() {
    Get.toNamed(AppRoutes.farmerRegistrationScreen,
