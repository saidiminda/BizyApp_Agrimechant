...
class ProducersManagementScreen
    extends GetWidget<ProducersManagementController> {
  const ProducersManagementScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: TopNavBar(
        ...
        title: "producersManagement".tr.toUpperCase(),
  ...
  onTapAddFarmer() {
    Get.toNamed(AppRoutes.producersRegistrationScreen,
