...
class WarehouseRegistrationController extends GetxController {
  ...
  Rx<SelectionPopupModel> selectedSourceOfEnergy =
      SelectionPopupModel(title: "").obs;
  Rx<SelectionPopupModel> selectedLogisticActivity =
      SelectionPopupModel(title: "").obs;
  ...
  List<SelectionPopupModel> areYouAwareOfAnyStandardsAndOrCertificationList = [
    SelectionPopupModel(title: "yes".tr, value: "YES"),
    SelectionPopupModel(title: "no".tr, value: "NO")
  ];
  ...
  Rx<SelectionPopupModel> selectedAreYouCurrentlyAMember =
      SelectionPopupModel(title: "").obs;
  Rx<SelectionPopupModel> selectedAreYouAwareOfAnyStandardsAndOrCertification =
      SelectionPopupModel(title: "").obs;
  ...
  RxList<Buyers> currentCustomer = <Buyers>[Buyers(), Buyers(), Buyers()].obs;
  RxList<LogisticsCrops> currentLogisticsCrops = <LogisticsCrops>[
    LogisticsCrops(),
    LogisticsCrops(),
    LogisticsCrops()
  ].obs;
  ...
  List<SelectionPopupModel> logisticActivityList = [
    SelectionPopupModel(
      title: "transportation".tr,
      value: "TRANSPORTATION",
    ),
    SelectionPopupModel(
      title: "warehousing".tr,
      value: "WAREHOUSING",
    ),
    SelectionPopupModel(
      title: "materialHandling".tr,
  ...
  RxList<LogisticsActivities> logisticsActivitiesList = <LogisticsActivities>[
    LogisticsActivities(
      title: "transportation".tr,
  ...
  void registerQuestionnaireResponse() async {
    ...
    currentQuestionnaireResponse.value.questionnaireCategoryId = 3;
    ...
    currentQuestionnaireResponse.value.basicInformation!.type = "WAREHOUSING";
    ...
    currentQuestionnaireResponse.value.socioEconomic!.buyers = currentCustomer;
    //******************** End Social Economic ***************//
