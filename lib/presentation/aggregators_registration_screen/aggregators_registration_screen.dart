...
import 'package:saidi_s_application3/data/models/apiModels/initial_data_response_model.dart';
...
class AggregatorsRegistrationScreen
    extends GetWidget<AggregatorsRegistrationController> {
  AggregatorsRegistrationScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => SafeArea(
        child: Scaffold(
          appBar: TopNavBar(
            title: "aggregatorsRegistration".tr.toUpperCase(),
          ),
          body: SizedBox(
