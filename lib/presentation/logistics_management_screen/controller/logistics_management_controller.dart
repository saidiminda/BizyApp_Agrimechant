...
import '../models/logistics_management_model.dart';
...
class LogisticsManagementController extends GetxController {
  Rx<InitialDataResponse> dashboardResponse = InitialDataResponse().obs;
  Rx<LogisticsManagementModel> farmerManagementModelObj =
      LogisticsManagementModel().obs;
