...
import 'controller/aggregators_management_controller.dart';
import 'package:flutter/material.dart';

class AggregatorsManagementScreen
    extends GetWidget<AggregatorsManagementController> {
  const AggregatorsManagementScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: TopNavBar(
        ...
        title: "aggregatorsManagement".tr.toUpperCase(),
  ...
  onTapAddFarmer() {
    Get.toNamed(AppRoutes.aggregatorsRegistrationScreen,
