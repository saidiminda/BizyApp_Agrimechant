...
class EquipmentProviderRegistrationScreen
    extends GetWidget<EquipmentProviderRegistrationController> {
  EquipmentProviderRegistrationScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
         appBar: TopNavBar(
          title: "equipmentProviderRegistration".tr.toUpperCase(),
        ),
        body: SizedBox(
