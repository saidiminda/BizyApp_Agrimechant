...
import '../models/input_supplier_management_model.dart';
...
class InputSupplierManagementController extends GetxController {
  Rx<InitialDataResponse> dashboardResponse = InitialDataResponse().obs;
  Rx<InputSupplierManagementModel> farmerManagementModelObj =
      InputSupplierManagementModel().obs;
