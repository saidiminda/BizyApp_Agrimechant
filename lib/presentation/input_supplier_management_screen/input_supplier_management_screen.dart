...
class InputSupplierManagementScreen
    extends GetWidget<InputSupplierManagementController> {
  const InputSupplierManagementScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: TopNavBar(
        ...
        title: "inputsSupplierSanagement".tr.toUpperCase(),
  ...
  onTapAddFarmer() {
    Get.toNamed(AppRoutes.inputSupplierRegistrationScreen,
