...
class WarehouseManagementScreen
    extends GetWidget<WarehouseManagementController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: TopNavBar(
        ...
        title: "warehousesManagement".tr.toUpperCase(),
  ...
  onTapAddFarmer() {
    Get.toNamed(AppRoutes.warehouseRegistrationScreen,
