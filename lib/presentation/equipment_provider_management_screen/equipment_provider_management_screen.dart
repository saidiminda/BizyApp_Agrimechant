...
class EquipmentProviderManagementScreen
    extends GetWidget<EquipmentProviderManagementController> {
  const EquipmentProviderManagementScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: TopNavBar(
        ...
        title: "equipmentProviderManagement".tr.toUpperCase(),
                                                  ...
                                                  child: PopupMenuButton<
                                                    ...
                                                    onSelected:
                                                      ...
                                                      if (item1 ==
                                                        ...
                                                        Get.toNamed(
                                                                AppRoutes
                                                                    .equipmentProviderRegistrationScreen,
                                                                arguments: {
                                                              "type": item
                                                                  .registrationStatus,
                                                              "questionnair":
  ...
  onTapAddFarmer() {
    Get.toNamed(AppRoutes.equipmentProviderRegistrationScreen,
