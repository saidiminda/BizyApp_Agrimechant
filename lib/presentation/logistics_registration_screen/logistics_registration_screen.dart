...
class LogisticsRegistrationScreen
    extends GetWidget<LogisticsRegistrationController> {
  LogisticsRegistrationScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
         appBar: TopNavBar(
          title: "logisticsRegistration".tr.toUpperCase(),
        ),
        body: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          "fromYourExperienceWhoAreYourMajorCompetitors"
                              .tr,
                          style: CustomTextStyles.titleSmallBluegray400,
                        ),
                      ),
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      height: 15.0,
                                      child: Text(
                                        '${"totalCapacity".tr} (MT)'.toUpperCase(),
                                        style: const TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 12,
                                          color: Color(0xff2bad4b),
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(4.0),
                                    child: Text(
                                      '${"actualVolumes".tr} (MT)'.toUpperCase(),
                                      style: const TextStyle(
                                        fontFamily: 'Montserrat',
                                        fontSize: 12,
                                        color: Color(0xff2bad4b),
